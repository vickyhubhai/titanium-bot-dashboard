...
export const Route = createFileRoute('/enterprise')({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Enterprise — Sentinel" },
...
const pillars = [
  ...
  { t: "Custom modules", d: "Bespoke moderation logic written and maintained by the Sentinel platform team." },
