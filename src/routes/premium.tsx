...
const comparisonMatrix = [
  { feature: "Latency response", free: "Standard (<150ms)", premium: "Ultra-low (<15ms)", enterprise: "Dedicated (<15ms)" },
  { feature: "Anti Nuke sensitivity", free: "Standard limits", premium: "SuperAntinuke signatures", enterprise: "Custom thresholds" },
  { feature: "Verification mechanisms", free: "CAPTCHA, Age gate", premium: "OAuth, VPN blocks, CAPTCHA", enterprise: "Custom auth flows" },
  { feature: "Logging retention", free: "7 Days", premium: "90 Days", enterprise: "Unlimited / S3 backup" },
  { feature: "Uptime SLA", free: "Best effort", premium: "99.9% uptime", enterprise: "99.99% dedicated" },
  { feature: "Tickets management", free: "1 active queue", premium: "Unlimited queues", enterprise: "Custom pipelines" }
];
