    ...
    <SiteShell>
      ...
      <article className="mx-auto max-w-3xl space-y-8 px-6 pb-28 text-sm leading-7 text-muted-foreground">
        <section>
          ...
          <p>To deliver the service, Titanium Security processes account identifiers from Discord (user ID, guild ID, role IDs), bot configuration you author in the dashboard, and operational telemetry such as command counts and error rates.</p>
        </section>
        <section>
